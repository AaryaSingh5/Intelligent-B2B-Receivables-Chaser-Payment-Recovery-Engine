...
st.set_page_config(
    page_title="Smart Receivables — Autonomous B2B Revenue Recovery Engine",
    page_icon="⚡",
    layout="wide",
...
def render():
    ...
    with st.sidebar:
        ...
        <div style="padding: 16px 0 10px 0;">
            <div style="display: flex; align-items: center; gap: 12px; margin-bottom: 8px;">
                ...
                <div>
                    <div style="font-weight: 800; font-size: 16px; color: #fff; letter-spacing: -0.02em;">Smart Receivables</div>
    ...
    <div class="executive-header">
        <div class="brand-section">
            ...
            <div>
                <h1 class="brand-title">Smart Receivables</h1>
            ...
            <div class="wa-mockup-wrapper">
                ...
                <div class="wa-chat-body">
                    ...
                    <div class="wa-bubble outbound" style="background: rgba(0, 92, 75, 0.65); border: 1px dashed rgba(52, 211, 153, 0.4);">
                        <div style="font-size: 11px; color: #34d399; font-weight: 700;">🤖 Smart Receivables AUTOMATION:</div>
